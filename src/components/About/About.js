		...
		<div className='About'>
			<div className='faded-about'>
				...
				<p className='about-text'>
					...
					and Styled components. Main functionality is based around being able
					to look up beers across the country, finding more information about
					each, and the happy place of their creation...with some additional
					info.
				</p>
			</div>
		</div>
